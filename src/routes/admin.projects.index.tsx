                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    ...
                    {!isCompleted && canModify && (
                      <Button onClick={() => confirmAdvance(proj.id)} className="h-9 gap-2">
                    ...
                    {PROJECT_STAGES.map((stage, idx) => {
                      ...
                      return (
                        <div key={stage} className="flex flex-col items-center gap-2 w-16">
                          ...
                          <div
                            className={`text-[10px] text-center font-medium leading-tight ${isCurrent ? "text-primary" : "text-muted-foreground"}`}
                          >
