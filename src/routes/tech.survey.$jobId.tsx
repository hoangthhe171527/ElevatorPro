...
import { mockJobs, mockLeads, formatDateTime, getCustomer, type Job } from "@/lib/mock-data";
...
export function TechSurveyDetail() {
  ...
  const handleComplete = async () => {
    ...
    if (isSmall) {
      toast.info(
        "Hệ thống: Lead đã được chuyển trạng thái 'Đã khảo sát'. CEO có thể lập báo giá ngay.",
      );
    }
  };
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-3">
            <StatusBadge variant={jobStatusVariant[status]} className="h-6 text-[8px]">
      ...
      <div className="grid gap-6 pb-12">
        ...
        <Card className="p-5 border-none shadow-sm bg-white">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-black uppercase text-slate-400">
                Kích thước thông thủy hố (RxS mm)
              </label>
              <Input
        ...
        <Card className="p-5 border-none shadow-sm bg-white">
          ...
          <div className="grid grid-cols-3 gap-2">
            {photos.map((p, idx) => (
              <div
                key={idx}
                className="aspect-square rounded-xl bg-slate-100 overflow-hidden relative group"
              >
          ...
          <div className="mt-4 p-3 rounded-xl bg-blue-50 border border-blue-100 flex items-start gap-2">
            ...
            <p className="text-[10px] text-blue-700 leading-relaxed font-medium">
              Yêu cầu chụp ít nhất 2 ảnh: Một ảnh bao quát mặt bằng và một ảnh chi tiết lòng hố
              thang.
            </p>
          </div>
        </Card>
        ...
        {status === "completed" && (
          <div className="p-8 text-center animate-in zoom-in duration-300">
            ...
            <p className="text-sm font-medium text-slate-500 mb-6">
              Dữ liệu khảo sát đã được gửi cho Sales/Sales Admin. <br /> Bạn có thể quay lại danh
              sách công việc.
            </p>
