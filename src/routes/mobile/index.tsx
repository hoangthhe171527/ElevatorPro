      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide -mx-4 px-4">
          ...
          <StatCardMobile
            ...
            color="bg-blue-500"
          />
          <StatCardMobile title="Sự cố" value="2" icon={AlertTriangle} color="bg-amber-500" />
        </div>
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Link to="/mobile/jobs" className="text-xs text-primary font-medium">
              Xem tất cả
            </Link>
          </div>
                  ...
                  <Card className="p-4 hover:bg-muted/30 transition-colors">
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground mt-1 truncate">{cus?.name}</p>
                        <div className="mt-2 flex items-center gap-3 text-[10px] text-muted-foreground">
                          ...
                          <span className="flex items-center gap-1 line-clamp-1">
                            <MapPin className="h-3 w-3" /> {cus?.address}
                          </span>
                        </div>
                      </div>
        ...
        <section className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="bg-background h-auto py-3 flex-col gap-2 font-semibold text-xs border-primary/20"
            >
