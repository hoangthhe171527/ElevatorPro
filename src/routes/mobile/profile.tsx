    ...
    <MobileShell title="Hồ sơ cá nhân">
      ...
      <div className="p-4 space-y-6">
            ...
            <Card className="divide-y border-none shadow-sm overflow-hidden">
              {group.items.map((item) => {
                ...
                return (
                  <button
                    key={item.label}
                    className="w-full h-14 flex items-center justify-between px-4 hover:bg-muted/30 active:bg-muted transition-colors text-left group"
                  >
        ...
        <Link to="/" className="block mt-4">
          <Button
            variant="ghost"
            className="w-full text-destructive hover:text-destructive hover:bg-destructive/5 gap-2 font-bold py-6 rounded-2xl border border-destructive/10"
          >
