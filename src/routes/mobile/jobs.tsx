  ...
  return (
    <MobileShell title="Lộ trình công việc">
      <div className="px-4 py-3 flex gap-2 overflow-x-auto bg-slate-50 border-b scrollbar-hide">
         <Button variant="secondary" size="sm" className="rounded-full bg-primary text-white text-[10px] font-bold h-7">Tất cả</Button>
         <Button variant="outline" size="sm" className="rounded-full text-[10px] bg-background border-slate-200 h-7">Đang chờ</Button>
         <Button variant="outline" size="sm" className="rounded-full text-[10px] bg-background border-slate-200 h-7">Đang làm</Button>
         <Button variant="outline" size="sm" className="rounded-full text-[10px] bg-background border-slate-200 h-7">Xong</Button>
         <Button variant="ghost" size="sm" className="rounded-full h-7 w-7 p-0 ml-auto"><Filter className="h-4 w-4" /></Button>
      </div>
            ...
            <Card key={job.id} className="p-4 shadow-sm border-none bg-background">
               <div className="flex justify-between items-start mb-3">
                  <div className="flex flex-col gap-1">
                     <span className="text-[10px] font-bold text-muted-foreground uppercase">{job.code}</span>
               ...
               <div className="space-y-2 mt-4 bg-slate-50 p-3 rounded-xl border border-slate-100">
                  <div className="flex items-start gap-2.5">
                     ...
                     <div className="min-w-0">
                        ...
                        <div className="text-[10px] text-muted-foreground line-clamp-1 mt-0.5">{cus?.address}</div>
                     </div>
                  </div>
                  <div className="flex items-center gap-2.5 pt-1 border-t border-slate-200/50 mt-1">
                     <Clock className="h-3.5 w-3.5 text-muted-foreground shrink-0" />
                     <span className="text-[10px] font-medium text-muted-foreground">Lên lịch: {job.scheduledFor}</span>
                  </div>
               </div>
               ...
               <div className="mt-4 flex items-center gap-2">
                  ...
                  <Button variant="secondary" size="icon" className="h-10 w-10 shrink-0 rounded-xl bg-slate-100 text-slate-600 border-none">
