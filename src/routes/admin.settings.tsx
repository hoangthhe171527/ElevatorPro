      ...
      <div className="grid gap-6 mt-6 max-w-4xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Quản lý cách thức và thời điểm bạn nhận được thông báo.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="email-notifs" className="flex flex-col space-y-1">
                ...
                <span className="font-normal text-xs text-muted-foreground">
                  Nhận báo cáo tổng hợp và cảnh báo quan trọng qua hòm thư.
                </span>
              </Label>
              <Switch
                id="email-notifs"
            ...
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="push-notifs" className="flex flex-col space-y-1">
                ...
                <span className="font-normal text-xs text-muted-foreground">
                  Nhận thông báo thời gian thực ngay trên trình duyệt.
                </span>
              </Label>
              <Switch
                id="push-notifs"
            ...
            <div className="flex items-center justify-between space-x-2">
              <Label htmlFor="sms-notifs" className="flex flex-col space-y-1">
                ...
                <span className="font-normal text-xs text-muted-foreground">
                  Chỉ áp dụng cho các sự cố khẩn cấp (Cấp độ Urgent).
                </span>
              </Label>
              <Switch
                id="sms-notifs"
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setAppearance((prev) => ({ ...prev, fontSize: v }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
