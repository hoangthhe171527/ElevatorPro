...
function ElevatorShell() {
  ...
  const isChildActive = matches.some((m) => m.routeId === "/admin/elevators/$elevatorId/qr");
    ...
    <AppShell>
      ...
      {(isDue || isOut) && (
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className={`h-12 w-12 rounded-full flex items-center justify-center shrink-0 ${isOut ? "bg-destructive/10" : "bg-warning/20"}`}
            >
            ...
            <div>
              <div className="font-bold text-base">
                {isOut
                  ? "Thang đang ngừng hoạt động do sự cố!"
                  : "Thang đã đến hạn bảo trì định kỳ!"}
              </div>
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="w-full justify-start h-auto p-1 bg-transparent border-b rounded-none gap-4 overflow-x-auto hide-scrollbar mb-6">
          <TabsTrigger
            value="overview"
            className="data-[state=active]:bg-muted data-[state=active]:shadow-sm rounded-lg px-4 py-2 gap-2 text-sm"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-5 border-muted/60 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <Row
                  label="Năm lắp đặt"
                  value={new Date(elevator.installedAt).getFullYear().toString()}
                />
            ...
            <Card className="p-5 border-muted/60 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-1.5 mt-2 bg-muted/30 px-3 rounded-lg border">
                  ...
                  <span
                    className={`font-bold ${isDue ? "text-warning-foreground" : "text-primary"}`}
                  >
            ...
            {history.length > 0 ? (
                          ...
                          {j.completedAt && (
                            <>
                              ...
                              <span className="text-success font-medium">
                                Hoàn thành {formatDateTime(j.completedAt)}
                              </span>
                            </>
                          )}
                        </div>
              ...
              <div className="py-20 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1 max-w-sm mx-auto">
                  Thang máy này chưa phát sinh lịch sử bảo trì hay sửa chữa nào trên hệ thống.
                </p>
            ...
            {contract ? (
              <div className="max-w-2xl mx-auto text-left py-4">
                ...
                <div className="grid sm:grid-cols-2 gap-y-6 gap-x-8 text-sm">
                  <div>
                    <div className="text-muted-foreground mb-1 uppercase tracking-wide text-xs font-semibold">
                      Loại hợp đồng
                    </div>
                  ...
                  <div>
                    ...
                    <StatusBadge variant={contract.status === "active" ? "success" : "muted"}>
                      {contract.status}
                    </StatusBadge>
                  </div>
                  <div>
                  ...
                  <div className="sm:col-span-2">
                    <div className="text-muted-foreground mb-2 uppercase tracking-wide text-xs font-semibold">
                      Hạng mục phục vụ
                    </div>
                ...
                <div className="mt-8 pt-6 flex gap-3">
                  <Link to="/admin/contracts">
                    <Button className="w-full sm:w-auto">Quản lý Hợp đồng</Button>
                  </Link>
                </div>
              </div>
            ) : (
              <div className="py-12">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Không tìm thấy hợp đồng bảo trì nào gắn với thang máy này.
                </p>
              </div>
            )}
          </Card>
...
function Row({ label, value, highlight }: { label: string; value: string; highlight?: boolean }) {
  return (
    <div className="flex items-center justify-between py-1.5 border-b border-muted/30 last:border-0 last:pb-0">
      ...
      <span className={`text-sm ${highlight ? "font-bold text-primary" : "font-medium"}`}>
        {value}
      </span>
    </div>
  );
