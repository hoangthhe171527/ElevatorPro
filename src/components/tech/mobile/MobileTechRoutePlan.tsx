      ...
      <Card className="m-4 rounded-[28px] overflow-hidden border-none shadow-2xl shadow-slate-900/10">
        <div className="h-[300px] relative">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex gap-2">
            <Button
              className="flex-1 h-12 rounded-xl bg-primary shadow-lg shadow-primary/20 gap-2 font-black text-xs"
              onClick={() => nextStop && openMapToStop(nextStop.lat, nextStop.lng, nextStop.label)}
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {isNext && (
                          <span className="h-4 px-2 rounded-full bg-primary/10 text-primary text-[8px] font-black uppercase flex items-center">
                            TIẾP THEO
                          </span>
                        )}
                      </div>
                    ...
                    {isNext && (
                      <div className="flex gap-2 mt-3">
                        <Button
                          size="sm"
                          className="h-8 flex-1 rounded-xl bg-slate-900 text-white font-black text-[10px] gap-2"
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          className="h-8 flex-1 rounded-xl border-slate-100 font-black text-[10px] gap-2"
