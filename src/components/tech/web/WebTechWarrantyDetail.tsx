            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/50 overflow-hidden">
              <CardHeader className="bg-slate-50 border-b p-8">
                <CardTitle className="text-xl font-black flex items-center gap-3">
                  <ClipboardCheck className="h-6 w-6 text-primary" /> Danh mục kiểm tra bảo trì bảo
                  hành
                </CardTitle>
              </CardHeader>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/50 p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                {status !== "completed" && (
                  <Button
                    ...
                    onClick={() => setPhotos([...photos, "/placeholder.svg"])}
                  >
              ...
              <div className="grid grid-cols-3 gap-6">
                {photos.map((p, i) => (
                  <div
                    key={i}
                    className="aspect-square bg-slate-100 rounded-[1.5rem] border-2 border-dashed border-slate-200 flex items-center justify-center"
                  >
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="grid grid-cols-1 gap-4 pt-4 border-t border-white/10">
                  ...
                  <p className="text-[10px] text-slate-400 italic">
                    Gói bảo hành: Gold Standard - Bao gồm vật tư tiêu hao.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="rounded-[2.5rem] border-2 border-slate-100 p-8">
              ...
              <div className="p-4 bg-orange-50 rounded-2xl border border-orange-100">
                <p className="text-xs font-bold text-orange-800 leading-relaxed">
                  Khách hàng yêu cầu kiểm tra kỹ phần cảm biến cửa do có trẻ nhỏ hay nghịch. Vệ sinh
                  kỹ rãnh cửa tầng 1.
                </p>
              </div>
            </Card>
