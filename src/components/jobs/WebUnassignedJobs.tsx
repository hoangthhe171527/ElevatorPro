...
import { mockJobs, getCustomer, getUser, formatDateTime } from "@/lib/mock-data";
...
export function WebUnassignedJobs() {
  ...
  const unassignedJobs = useMemo(() => {
    return mockJobs
      .filter(
        (j) => j.tenantId === activeTenantId && j.status === "pending" && j.type !== "install", // Installation is in the Projects module
      )
      .sort((a, b) => {
    ...
    <AppShell>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {pagedJobs.map((job) => {
          ...
          const Icon =
            job.type === "maintenance" ? Activity : job.type === "warranty" ? ShieldCheck : Wrench;
          ...
          return (
            ...
            >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <StatusBadge
                      ...
                      className="w-fit h-auto py-0.5 text-[8px] uppercase font-black"
                    >
              ...
              <CardFooter className="pt-0 pb-6 px-6">
                <Link to="/admin/jobs/$jobId" params={{ jobId: job.id }} className="w-full">
        ...
        {unassignedJobs.length === 0 && (
          <div className="col-span-full py-20 text-center">
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Tất cả các công việc đã được điều phối hết.
            </p>
          </div>
        )}
      </div>
