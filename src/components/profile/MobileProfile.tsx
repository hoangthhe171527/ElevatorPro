...
export function MobileProfile() {
  ...
  return (
    <AppShell>
      <PageHeader
        title="Tài khoản"
        description="Quản lý định danh cá nhân"
      />
      ...
      <div className="flex flex-col gap-6 pb-8 -mt-2">
         ...
         <div className="space-y-1">
            <div className="text-[11px] font-black text-slate-400 uppercase tracking-widest px-4 mb-2">Thông tin liên hệ</div>
            <div className="bg-white rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-slate-100 overflow-hidden">
               {/* Item */}
               <div className="flex items-center p-4 border-b border-slate-50 hover:bg-slate-50 active:bg-slate-100 transition-colors" onClick={() => toast.success("Mở form sửa SDT")}>
                  ...
                  <div className="flex-1">
                     ...
                     <div className="text-[12px] font-medium text-slate-500 mt-0.5">{user.phone || "Chưa thiết lập"}</div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-slate-300" />
               </div>
               {/* Item */}
               <div className="flex items-center p-4 hover:bg-slate-50 active:bg-slate-100 transition-colors" onClick={() => toast.success("Mở form sửa Email")}>
                  ...
                  <div className="flex-1">
                     ...
                     <div className="text-[12px] font-medium text-slate-500 mt-0.5">{user.email || "Chưa thiết lập"}</div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-slate-300" />
               </div>
            </div>
         ...
         <div className="space-y-1">
            <div className="text-[11px] font-black text-slate-400 uppercase tracking-widest px-4 mb-2">Bảo mật & Thiết bị</div>
            <div className="bg-white rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-slate-100 overflow-hidden">
               {/* Item */}
               <div className="flex items-center p-4 border-b border-slate-50 hover:bg-slate-50 active:bg-slate-100 transition-colors" onClick={() => setConfirmPassword(true)}>
               ...
               <div className="flex items-center p-4 border-b border-slate-50">
                  ...
                  <span className="text-[10px] bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded font-black uppercase tracking-widest">Đã Bật</span>
               </div>
               {/* Item */}
               <div className="flex items-center p-4 hover:bg-slate-50 active:bg-slate-100 transition-colors" onClick={() => toast.success("Quản lý thiết bị")}>
                  ...
                  <div className="flex-1">
                     ...
                     <div className="text-[12px] font-medium text-slate-500 mt-0.5">2 thiết bị đang kết nối</div>
                  </div>
                  <ChevronRight className="h-4 w-4 text-slate-300" />
               </div>
            </div>
         ...
         <div className="space-y-1">
            <div className="text-[11px] font-black text-slate-400 uppercase tracking-widest px-4 mb-2">Cài đặt Ứng dụng</div>
            <div className="bg-white rounded-[20px] shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-slate-100 overflow-hidden">
         ...
         {/* Logout Button */}
         <button onClick={() => setConfirmLogout(true)} className="mt-2 w-full bg-rose-50 border border-rose-100 rounded-[20px] p-4 flex items-center justify-center gap-2 text-rose-500 active:bg-rose-100 transition-colors shadow-sm">
            <LogOut className="h-4 w-4" />
            <span className="font-black text-[13px] uppercase tracking-widest">Đăng xuất khỏi App</span>
         </button>
      </div>
