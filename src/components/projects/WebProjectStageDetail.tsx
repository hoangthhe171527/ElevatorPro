      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
           ...
           <div className="flex items-center gap-3">
              <StatusBadge variant={priorityVariant[job.priority]} className="px-4 py-1.5 rounded-xl uppercase font-black tracking-widest text-[10px]">
                {priorityLabel[job.priority]}
              </StatusBadge>
              <StatusBadge variant={jobStatusVariant[job.status]} className="px-4 py-1.5 rounded-xl uppercase font-black tracking-widest text-[10px]">
           ...
           <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-10 bg-white overflow-hidden relative">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                       ...
                       <div>
                          <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Trạng thái kỹ thuật</div>
                          <h3 className="font-black text-3xl text-slate-800 leading-none mb-2">
                             {isCompleted ? "Đã Hoàn Thành" : "Đang Thi Công"}
                          </h3>
                          <Badge variant="outline" className="bg-slate-50 text-slate-500 border-slate-200 font-bold px-3 py-1 rounded-lg">
                    ...
                    {isCompleted && (
                      <div className="bg-emerald-50 border border-emerald-100 px-6 py-4 rounded-[2rem] flex items-center gap-3">
                         ...
                         <div>
                            <div className="text-xs font-black text-emerald-800 uppercase tracking-wider">Hệ thống xác nhận</div>
                            <div className="text-[11px] text-emerald-600 font-bold">Kỹ thuật đã chốt giai đoạn này.</div>
                         </div>
                      </div>
                    )}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-8 bg-white">
                    ...
                    <div className="aspect-video rounded-[2rem] bg-slate-100 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400">
                       ...
                       <span className="text-[10px] font-black uppercase tracking-widest">Ảnh thực tế kỹ thuật chụp</span>
                    </div>
                 </Card>
                 <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-8 bg-white">
                    <h3 className="font-black text-sm uppercase tracking-widest text-slate-400 mb-6 flex items-center gap-2">
                    ...
                    <div className="aspect-video rounded-[2rem] bg-slate-100 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400">
                       <Camera className="h-10 w-10 mb-2 opacity-20" />
                       <span className="text-[10px] font-black uppercase tracking-widest">Ảnh xác nhận hoàn tất kỳ</span>
                    </div>
                 </Card>
              </div>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-10 bg-white">
                 <div className="flex items-center gap-3 mb-8">
                    ...
                    <h3 className="font-black text-lg text-slate-800">Biên bản Bàn giao & Ghi chú Kỹ thuật</h3>
                 </div>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-8 bg-slate-900 text-white">
                 ...
                 <div className="space-y-4">
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
                       <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Lịch thực hiện</div>
                       <div className="text-lg font-black text-white flex items-center gap-2">
                         <Calendar className="h-4 w-4 text-primary" /> {formatDateTime(job.scheduledFor).split(',')[0]}
                       </div>
                    </div>
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/10">
                       <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Trạng thái hiện trường</div>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-xl shadow-slate-200/40 p-8 bg-white">
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-slate-100 flex items-start gap-3">
                       ...
                       <div className="text-xs text-slate-600 font-medium leading-relaxed">{cus?.address}</div>
                    </div>
                 </div>
              </Card>
           </div>
