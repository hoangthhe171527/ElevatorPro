                  ...
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {job && (
                          <StatusBadge
                            ...
                            className="scale-75 origin-left h-4 px-1.5 py-0 text-[8px]"
                          >
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100/50">
                      {job ? (
                        ...
                        <div className="text-[9px] text-slate-400 font-black uppercase tracking-widest italic text-center">
                          Chưa bắt đầu
                        </div>
                      )}
                    </div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge
                    variant="outline"
                    className="bg-primary/20 border-primary/30 text-primary text-[10px] px-2 py-0"
                  >
            ...
            <div className="space-y-4">
                  ...
                  <div key={j.id} className="flex gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-[8px] text-slate-400 uppercase">
                        {formatDate(j.completedAt || j.scheduledFor)}
                      </div>
                    </div>
                  </div>
                ))}
              {jobs.filter((j) => j.status === "completed").length === 0 && (
                <div className="text-[10px] text-slate-400 italic">
                  Chưa có giai đoạn nào hoàn tất
                </div>
              )}
            </div>
          </Card>
