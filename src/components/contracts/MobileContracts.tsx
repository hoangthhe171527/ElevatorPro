      ...
      <div className="bg-slate-900 text-white rounded-[2rem] p-6 mb-6 shadow-xl shadow-slate-900/20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between gap-4 pt-4 border-t border-slate-700/50 mt-4">
            ...
            <div>
              <div className="text-[9px] font-bold text-emerald-400/80 uppercase tracking-widest mb-0.5">
                Đã thu hồi
              </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  <StatusBadge
                    variant={contractStatusVariant[c.status]}
                ...
                <div className="flex gap-2">
                  ...
                  {c.status === "draft" && isDirector && (
                    <Button
                      ...
                      variant="outline"
                      className={cn(
                        "flex-1 h-9 rounded-xl text-[11px] font-black uppercase",
                        c.contractFileUrl
